...
alias tkwin='tmux kill-window'
alias tswin0='tmux select-window -t:0'
alias tswin1='tmux select-window -t:1'
alias tswin2='tmux select-window -t:2'
alias tswin3='tmux select-window -t:3'
alias tswin4='tmux select-window -t:4'
alias tswin5='tmux select-window -t:5'
alias tswin6='tmux select-window -t:6'
alias tswin7='tmux select-window -t:7'
alias tswin8='tmux select-window -t:8'
alias tswin9='tmux select-window -t:9'
alias tvpane='tmux split-window'
alias thpane='tmux split-window -h'
